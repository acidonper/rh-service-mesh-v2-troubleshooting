...
.params file content
====
USER_NAMESPACE=user1-namespace +
...
[source,bash,subs="+macros,+attributes"]
----
oc process -f ./02-jump-app-deploy/jump-app-template.yml --param-file=./params.env --ignore-unknown-parameters | oc create -f - -n <user_namespace>
----

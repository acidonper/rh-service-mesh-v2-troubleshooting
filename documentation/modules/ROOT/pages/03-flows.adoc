...
In order to add this new project to the Service Mesh and make possible the traffic between each microservice, it is required to create a new _ServiceMeshMember_ object.
...
:file: 03-jump-app-flows/05-jump-app-ns-smr.yaml
:namespace: <user_namespace>

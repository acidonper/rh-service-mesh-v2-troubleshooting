...
image::ocp-istio-gen-cert-req.png[]
...
----
oc project istio-system
oc exec <ingress_gateway_pod_id> -- mkdir /tmp/<user_namespace>
oc cp istio.test.crt <ingress_gateway_pod_id>:/tmp/<user_namespace>
oc cp istio.test.key <ingress_gateway_pod_id>:/tmp/<user_namespace>
oc cp ca-cert.pem <ingress_gateway_pod_id>:/tmp/<user_namespace>
----
...
image::jump-app-trou-05-k8ssrv-cert.png[]
...
.HTTP Response 200
image::jump-app-trou-05-k8ssrv-cert-ok.png[]

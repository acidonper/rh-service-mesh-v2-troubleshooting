...
[source,input,subs="+macros,+attributes"]
----
oc exec <back_golang_pod_id> -c istio-proxy -- curl localhost:15000/config_dump > dump.json
----
...
[source,input,subs="+macros,+attributes"]
----
oc exec <back_golang_pod_id> -c istio-proxy -- curl localhost:15000/stats > stats.txt
----
...
[source,input,subs="+macros,+attributes"]
----
oc exec <back_golang_pod_id> -c istio-proxy -- curl -X POST localhost:15000/logging
----
...
[source,input,subs="+macros,+attributes"]
----
oc exec <back_golang_pod_id> -c istio-proxy -- curl -X POST localhost:15000/logging?http=debug
----
...
[source,input,subs="+macros,+attributes"]
----
oc logs -f <back_golang_pod_id> -c istio-proxy
----
